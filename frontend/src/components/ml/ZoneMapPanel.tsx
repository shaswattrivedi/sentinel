...
const ZoneCard: React.FC<{
  ...
  return (
    ...
    >
      ...
      <div style={{ color: "#f8fafc", fontSize: 16, fontWeight: 700, marginTop: 4 }}>People: {data.cam_people_count}</div>

      <div style={{ marginTop: "auto" }}>
        <div style={{ color: "rgba(248, 250, 252, 0.85)", fontSize: 14, fontWeight: 600, marginBottom: 8, letterSpacing: 0.4 }}>
          Sensor Validation
        </div>
        <div
          style={{
      ...
      <div style={{ color: visual.text, fontWeight: 800, fontSize: 14, marginTop: 14, display: "flex", alignItems: "center", gap: 6 }}>
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", flex: 1, justifyContent: "center" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr auto 1fr", gap: 12, alignItems: "stretch" }}>
          ...
          <div style={{ width: 120, textAlign: "center", alignSelf: "center", display: "flex", flexDirection: "column", justifyContent: "center" }}>
